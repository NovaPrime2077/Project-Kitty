def main(Landmarks_folder):
    ...
    RIGHT_MODEL_PATH = os.path.join(SCRIPT_DIR, "NovaPrime2077_right.keras")
    LEFT_MODEL_PATH = os.path.join(SCRIPT_DIR, "NovaPrime2077_left.keras")
    print("Looking for right model at:", RIGHT_MODEL_PATH)
    print("Looking for left model at:", LEFT_MODEL_PATH)

    right = keras.models.load_model(RIGHT_MODEL_PATH)
    left = keras.models.load_model(LEFT_MODEL_PATH)
    right.summary()
    left.summary()
